...
bash scripts/environment/initialize_conan.sh  # Conan install + CMake configure
```

`initialize_conan.sh` is the authoritative setup script — see
...
`--compile-commands-dir=${workspaceFolder}/build/Debug`. This file is generated by CMake
